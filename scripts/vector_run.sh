...
#SBATCH --job-name=vector_spmv_benchmark
#SBATCH --output=vector_spmv_benchmark-%j.out
#SBATCH --error=vector_spmv_benchmark-%j.err
#SBATCH --nodelist=edu01

# Define executable and base directory
EXEC=~/GPU-Computing-2025-256137/bin/spmv_gpu_vector_csr.exec

...
#SBATCH --job-name=adaptive_spmv
#SBATCH --output=adaptive_spmv-%j.out
#SBATCH --error=adaptive_spmv-%j.err
#SBATCH --nodelist=edu01

# Define executable and base directory
EXEC=~/GPU-Computing-2025-256137/bin/spmv_gpu_adaptive_csr.exec

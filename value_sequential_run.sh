...
#SBATCH --job-name=value_sequential_spmv_benchmark
#SBATCH --output=value_sequential_spmv_benchmark-%j.out
#SBATCH --error=value_sequential_spmv_benchmark-%j.err
#SBATCH --nodelist=edu01

# Define executable and base directory
EXEC=~/GPU-Computing-2025-256137/bin/spmv_gpu_value_sequential_csr.exec

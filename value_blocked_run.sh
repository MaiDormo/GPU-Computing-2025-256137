...
#SBATCH --job-name=value_blocked_spmv_benchmark
#SBATCH --output=value_blocked_spmv_benchmark-%j.out
#SBATCH --error=value_blocked_spmv_benchmark-%j.err
#SBATCH --nodelist=edu01

# Define executable and base directory
EXEC=~/GPU-Computing-2025-256137/bin/spmv_gpu_value_blocked_csr.exec

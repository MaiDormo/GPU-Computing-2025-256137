...
#SBATCH --job-name=simple_spmv_benchmark
#SBATCH --output=simple_spmv_benchmark-%j.out
#SBATCH --error=simple_spmv_benchmark-%j.err
#SBATCH --nodelist=edu01

# Define executable and base directory
EXEC=~/GPU-Computing-2025-256137/bin/spmv_gpu_simple_csr.exec
